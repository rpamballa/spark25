...
const EditProfile = () => {
    ...
    useEffect(() => {
        ...
        if(accessToken){
            axios.post(`${import.meta.env.VITE_API_URL}/get-profile`, { username: userAuth.username })
            .then(({ data }) => {
                setProfile(data);
                setLoading(false);
            })
    ...
    const handleImageUpload = (e) => {
        ...
        if(updatedProfileImg){
            ...
            .then(url => {
                ...
                if(url){
                    axios.post(`h${import.meta.env.VITE_API_URL}/update-profile-img`, { url }, {
                        headers: { 
    ...
    const handleSubmit = (e) => {
        ...
        axios.post(`"${import.meta.env.VITE_API_URL}/update-profile`, {
            username, bio, 
