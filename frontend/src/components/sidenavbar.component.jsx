...
const SideNav = () => {
  let {
    userAuth: { accessToken, new_notification_available, isAdmin },
          ...
          >
            ...
            {/* {isAdmin && (
              <>
                ...
                <NavLink
                  to="/blog/dashboard/manage-users"
                  onClick={(e) => setPageState(e.target.innerText)}
                  className="sidebar-link"
                >
            ...
            {/* <NavLink
              to="/blog/dashboard/notifications"
              onClick={(e) => setPageState(e.target.innerText)}
              className="sidebar-link"
            >
            ...
            <NavLink
              to="/blog/settings/change-password"
              onClick={(e) => setPageState(e.target.innerText)}
              className="sidebar-link"
            >
